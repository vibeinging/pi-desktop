...
function positiveUsageNumber(...values: Array<number | undefined>): number {
...
function parseChunkUsage(
	...
	const cacheReadTokens = positiveUsageNumber(
		rawUsage.prompt_tokens_details?.cached_tokens,
		rawUsage.prompt_cache_hit_tokens,
		rawUsage.cache_input_tokens,
		rawUsage.cached_tokens,
		rawUsage.cache_read_input_tokens,
	);
	const retentionCacheWrite =
		positiveUsageNumber(rawUsage.prompt_tokens_details?.cache_creation?.ephemeral_5m_input_tokens) +
		positiveUsageNumber(rawUsage.prompt_tokens_details?.cache_creation?.ephemeral_1h_input_tokens);
	const cacheWriteTokens = positiveUsageNumber(
		rawUsage.prompt_tokens_details?.cache_write_tokens,
		rawUsage.prompt_tokens_details?.cache_creation_input_tokens,
		rawUsage.prompt_tokens_details?.cache_creation?.cache_creation_input_tokens,
	...
	// DashScope reports explicit cache writes as cache_creation_input_tokens.
