/*js 错误日志收集*/
// TODO(migration): js-error-collection 需加入 app/renderer/package.json 依赖
...
export const useErrorLog = () => {
  ...
  if (settings.errorLog?.includes(import.meta.env.VITE_APP_ENV)) {
    jsErrorCollection({ runtimeError: true, rejectError: true, consoleError: true }, (errLog: string) => {
